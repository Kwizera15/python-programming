...
/*# sourceURL=ace/css/ace_editor.css */</style><script src="./even ,odd sum_files/973535300821278" async=""></script><script async="" src="./even ,odd sum_files/fbevents.js.download"></script><script async="" src="./even ,odd sum_files/coreid.min.js.download"></script><script async="" src="./even ,odd sum_files/launcher.min.js.download"></script><script src="./even ,odd sum_files/rules-p-31iz6hfFutd16.js.download" async=""></script><script src="./even ,odd sum_files/quant.js.download" async="true"></script><script async="" defer="" src="./even ,odd sum_files/launchpad.bundle.js.download"></script><script src="./even ,odd sum_files/hadron.js.download"></script><script src="./even ,odd sum_files/apstag.js.download" async="true"></script><script type="text/javascript" async="" src="./even ,odd sum_files/analytics.js.download"></script><script type="text/javascript" async="" src="./even ,odd sum_files/js"></script><script src="./even ,odd sum_files/f.txt"></script><script>var __ezHttpConsent={setByCat:function(src,tagType,attributes,category,force){var setScript=function(){if(force||window.ezTcfConsent[category]){var scriptElement=document.createElement(tagType);scriptElement.src=src;attributes.forEach(function(attr){for(var key in attr){if(attr.hasOwnProperty(key)){scriptElement.setAttribute(key,attr[key]);}}});var firstScript=document.getElementsByTagName(tagType)[0];firstScript.parentNode.insertBefore(scriptElement,firstScript);}};if(force||(window.ezTcfConsent&&window.ezTcfConsent.loaded)){setScript();}else if(typeof getEzConsentData==="function"){getEzConsentData().then(function(ezTcfConsent){if(ezTcfConsent&&ezTcfConsent.loaded){setScript();}else{console.error("cannot get ez consent data");force=true;setScript();}});}else{force=true;setScript();console.error("getEzConsentData is not a function");}},};</script>
...
<link rel="preload" as="script" href="./even ,odd sum_files/f(2).txt">
<link rel="preload" as="script" href="./even ,odd sum_files/dall.js.download">
...
__ez.queue.addFunc("productEzoicAds", "productEzoicAds", null, true, ['ezaqReady'], false, false, false, true);
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="./even ,odd sum_files/bootstrap.min.css">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="./even ,odd sum_files/all.min.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="./even ,odd sum_files/ide.css">

    <!-- Google Font -->
    <link rel="stylesheet" href="./even ,odd sum_files/css" ezfontsrc="https://fonts.googleapis.com/css?display=swap&amp;family=Source+Sans+Pro%3A300%2C400%2C600%2C700%2C300italic%2C400italic%2C600italic" as="style">

    <!-- jQuery 3 -->
    <script src="./even ,odd sum_files/jquery.min.js.download"></script>
    <!-- Bootstrap 3.3.7 -->
    <script src="./even ,odd sum_files/bootstrap.min.js.download"></script>

    <script src="./even ,odd sum_files/ide.js.download"></script>

    <!-- Ace Editor -->
    <script src="./even ,odd sum_files/ace.js.download" type="text/javascript" charset="utf-8"></script>
    <script src="./even ,odd sum_files/ext-language_tools.min.js.download" type="text/javascript" charset="utf-8"></script>
    <script src="./even ,odd sum_files/ext-settings_menu.min.js.download" type="text/javascript" charset="utf-8"></script>
    <script async="" src="./even ,odd sum_files/ext-keybinding_menu.min.js.download" type="text/javascript" charset="utf-8"></script>

    <!-- Split JS -->
    <script type="text/javascript" src="./even ,odd sum_files/split.min.js.download"></script>

    <link rel="stylesheet" href="./even ,odd sum_files/toastr.min.css">

    <script src="./even ,odd sum_files/toastr.min.js.download"></script>

    <script async="" src="./even ,odd sum_files/socket.io.js.download"></script>
...
<script async="" src="./even ,odd sum_files/js(1)"></script>
<script>
...
<script data-ad-client="ca-pub-8595466052839863" async="" src="./even ,odd sum_files/f(1).txt" data-checked-head="true"></script>
...
</script><script src="./even ,odd sum_files/mulvane.js.download" async=""></script><script src="./even ,odd sum_files/et.js.download" async=""></script><script src="./even ,odd sum_files/reno.js.download" async=""></script><script src="./even ,odd sum_files/wichita.js.download" async=""></script><script src="./even ,odd sum_files/raleigh.js.download" async=""></script><script src="./even ,odd sum_files/vista.js.download" async=""></script><script src="./even ,odd sum_files/drake.js.download" async=""></script><script src="./even ,odd sum_files/jellyfish.js.download" async=""></script><script src="./even ,odd sum_files/python.js.download"></script><script src="./even ,odd sum_files/olathe.js.download" async=""></script><script src="./even ,odd sum_files/vitals.js.download" async=""></script><script src="./even ,odd sum_files/chanute.js.download" async=""></script><script type="text/javascript">var ezStaticAnchor = function(anchorXPath, htmlStr, isRequired) {
...
} catch(e) {window.ezstaticerrors = (window.ezstaticerrors || '') + e.toString();}window.ezFinishedStatic=true;</script><script src="./even ,odd sum_files/calgary.js.download"></script><script async="" type="text/javascript" src="./even ,odd sum_files/f(2).txt"></script><script src="./even ,odd sum_files/banger.js.download" async=""></script><script src="./even ,odd sum_files/reportads.js.download"></script><style>.ezoic-ad.medrectangle-2100{display:inline-block;float:none !important;line-height:0px;max-width:100% !important;min-height:90px;min-width:0px;padding:0;}</style><style>.ezoic-ad.box-2119{align-items:center;display:flex !important;flex-direction:column !important;float:none !important;justify-content:center;line-height:0px;margin-bottom:0px !important;margin-left:auto !important;margin-right:auto !important;margin-top:0px !important;max-width:100% !important;min-height:600px;min-width:250px;padding:0;text-align:center !important;}</style><style>.ezoic-ad.medrectangle-3136{align-items:center;display:flex !important;flex-direction:column !important;float:none !important;justify-content:center;line-height:0px;margin-bottom:0px !important;margin-left:auto !important;margin-right:auto !important;margin-top:0px !important;max-width:100% !important;min-height:600px;min-width:250px;padding:0;text-align:center !important;}</style><style>.ezoic-ad{display:inline-block;border:0px;}.ezoic-ad>div>iframe{margin:0px!important;padding:0px!important;width:revert-layer;}.ezoic-ad .ezoic-ad>div{text-align:center}</style><style>.ad-reporter-menu-backdrop{display:none;position:absolute;bottom:20px;right:15px;width:120px;height:100px;flex-direction:row;justify-content:center;align-items:center;background:transparent;box-shadow:#000 0 2px 10px;border-radius:10px;z-index:1002}.ad-reporter-menu{position:absolute;z-index:1003;display:flex;flex-direction:column;width:100%;height:100%;background:#fff;border-radius:5px;align-items:center;justify-content:space-around;font-weight:200;font-size:14px;font-family:sans-serif}.ad-reporter-menu .ad-reporter-menu-item{width:100%;height:100%;cursor:pointer;display:flex;justify-content:center;align-items:center}.ad-reporter-menu .ad-reporter-menu-item:not(:last-child){border-bottom:solid #d3d3d3 1px}</style><style>@keyframes ezIn { 			from { opacity: 0; } 		  }		  .ezoic-ad .ezoic-adl:before {content: '\00B7\00B7\00B7';position: absolute;display: flex!important;align-items: center;justify-content: center;text-align: center;color: #C4C4C4;font-size: 62px;letter-spacing: 2px;z-index: 0;animation: ezIn 1s infinite alternate;left: 50%;top: 50%;transform: translate(-50%, -50%);} .ezoic-ad .ezfound,.ezmob-footer .ezoic-ad .ezoic-ad,.ezoic-ad-adaptive > .ezoic-ad, .ezoic-ad-rl {background:0 0;border-radius:0;border:none}</style><style>.ezmob-footer{position:fixed;left:0;bottom:0;width:100%;background:#fff;z-index:100000;line-height:0}.ezmob-footer-desktop{background-color:#f6f6f6cc;white-space:nowrap}.ezmob-footer-close-wrap{height:90px;padding:3px 0 0 16px;display:inline-block;width:35px;vertical-align:top}span.ezmob-footer-close{cursor:pointer;display:inline-block;width:18px;height:18px;border-radius:50%;border:1px solid #696969;position:relative;background:#fff;opacity:1}span.ezmob-footer-close:hover{border:1px solid #5fa624}span.ezmob-footer-close::before,span.ezmob-footer-close::after{content:'';position:absolute;top:50%;left:50%;width:60%;height:1px;background:#696969}span.ezmob-footer-close::before{transform:translate(-50%,-50%) rotate(45deg)}span.ezmob-footer-close::after{transform:translate(-50%,-50%) rotate(-45deg)}img.ezmob-anchor-img{height:18px!important;padding:0!important;border:0!important;cursor:pointer!important;width:18px!important;margin:45px 0 3px 1px!important;box-sizing:content-box!important}@media(min-width:450px) and (max-width:780px){.ezmob-footer-close-wrap,.ezoicwhat{display:none!important}}.ezoicwhat{display:block}body {					padding-bottom: 100px !important;					height: auto;				}				</style><script src="./even ,odd sum_files/v.js.download"></script><script src="./even ,odd sum_files/stickyfix.js.download" async=""></script><script src="./even ,odd sum_files/anchorfix.js.download" async=""></script><script src="./even ,odd sum_files/kenai.js.download" async=""></script><script src="./even ,odd sum_files/tuscon.js.download" async=""></script><script src="./even ,odd sum_files/kenai.js.download" async=""></script><script src="./even ,odd sum_files/portland.js.download" async=""></script><meta http-equiv="origin-trial" content=""><meta http-equiv="origin-trial" content=""><meta http-equiv="origin-trial" content=""><meta http-equiv="origin-trial" content=""><script src="./even ,odd sum_files/f(3).txt" async=""></script><script src="./even ,odd sum_files/aa05931b-5308-4ea3-95a2-adf84f4ffde4" type="text/javascript" async="async"></script><script async="async" defer="defer" src="./even ,odd sum_files/launchpad-liveramp.js.download"></script><script src="./even ,odd sum_files/pubcid.min.js.download"></script><script src="./even ,odd sum_files/sync.min.js.download"></script><script src="./even ,odd sum_files/id5-api.js.download"></script><script type="text/javascript" async="" src="./even ,odd sum_files/launcher-stub.min.js.download"></script><script src="./even ,odd sum_files/audins.js.download" async="" type="text/javascript"></script><script src="./even ,odd sum_files/524" async=""></script><script src="./even ,odd sum_files/js(2)" async=""></script></head>
<body style="padding-bottom: 100px !important;">
<ins class="adsbygoogle adsbygoogle-noablate" data-adsbygoogle-status="done" style="display: none !important;" data-ad-status="unfilled"><div id="aswift_0_host" style="border: none; height: 0px; width: 0px; margin: 0px; padding: 0px; position: relative; visibility: visible; background-color: transparent; display: inline-block;"><iframe id="aswift_0" name="aswift_0" browsingtopics="true" style="left:0;position:absolute;top:0;border:0;width:undefinedpx;height:undefinedpx;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allow="attribution-reporting; run-ad-auction" src="./even ,odd sum_files/ads.html" data-google-container-id="a!1" tabindex="0" title="Advertisement" aria-label="Advertisement" data-load-complete="true"></iframe></div></ins><div>
<nav class="nav navbar-top primary">
    <h2 class="nav_logo">
        <!-- <i class="fab fa-product-hunt"></i> -->
        <a href="https://www.online-python.com/"><img src="./even ,odd sum_files/logo.png" alt="IDE" width="40" height="34" style="margin-top: -7px" ezimgfmt="rs rscb4 src ng ngcb4" class=" ezlazyloaded" data-ezsrc="logo.png?ezimgfmt=rs:40x34/rscb4/ngcb4/notWebP" ezoid="0.12436056359264902"></a>
...
<div class="container" id="container">
    ...
    <div id="mi" class="split" style="height: calc(66% - 2.5px);">
        ...
        <div id="editor" class=" ace_editor ace-tm" style="line-height: 1.5;" draggable="false"><div style="position: absolute;"></div><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 168px; left: 214px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 41px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: 0px; left: 0px; width: 41px;"><div class="ace_gutter-cell " style="height: 21px; top: 0px;">1<span class="ace_fold-widget ace_start ace_open" style="display: inline-block; height: 21px;"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 21px;">2<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 21px;"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 42px;">3<span style="display: none; height: 21px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 63px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 84px;">5<span style="display: none; height: 21px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 105px;">6<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 21px;"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 126px;">7<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 21px;"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 21px; top: 147px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 21px; top: 168px;">9<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 21px;"></span></div></div></div><div class="ace_scroller" style="line-height: 21px; left: 40.6973px; right: 0px; bottom: 0px;"><div class="ace_content" style="top: 0px; left: 0px; width: 971.303px; height: 406px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 620px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_bracket ace_start ace_br15" style="height: 21px; width: 7.69727px; top: 147px; left: 165.643px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 21px; width: 7.69727px; top: 147px; left: 204.129px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line" style="height: 21px; top: 0px;"><span class="ace_keyword">def</span> <span class="ace_identifier">sum_even_odd</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">lst</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation">:</span></div><div class="ace_line" style="height: 21px; top: 21px;">    <span class="ace_identifier">even_sum</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">sum</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">num</span> <span class="ace_keyword">for</span> <span class="ace_identifier">num</span> <span class="ace_keyword">in</span> <span class="ace_identifier">lst</span> <span class="ace_keyword">if</span> <span class="ace_identifier">num</span> <span class="ace_keyword ace_operator">%</span> <span class="ace_constant ace_numeric">2</span> <span class="ace_keyword ace_operator">==</span> <span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">)</span></div><div class="ace_line" style="height: 21px; top: 42px;">    <span class="ace_identifier">odd_sum</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">sum</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">num</span> <span class="ace_keyword">for</span> <span class="ace_identifier">num</span> <span class="ace_keyword">in</span> <span class="ace_identifier">lst</span> <span class="ace_keyword">if</span> <span class="ace_identifier">num</span> <span class="ace_keyword ace_operator">%</span> <span class="ace_constant ace_numeric">2</span> <span class="ace_keyword ace_operator">!=</span> <span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">)</span></div><div class="ace_line" style="height: 21px; top: 63px;">    <span class="ace_keyword">return</span> <span class="ace_paren ace_lparen">(</span><span class="ace_identifier">even_sum</span><span class="ace_punctuation">,</span> <span class="ace_identifier">odd_sum</span><span class="ace_paren ace_rparen">)</span></div><div class="ace_line" style="height: 21px; top: 84px;"></div><div class="ace_line" style="height: 21px; top: 105px;"></div><div class="ace_line" style="height: 21px; top: 126px;"><span class="ace_support ace_function">list</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_paren ace_lparen">[</span><span class="ace_constant ace_numeric">1</span><span class="ace_punctuation">,</span> <span class="ace_constant ace_numeric">2</span><span class="ace_punctuation">,</span> <span class="ace_constant ace_numeric">3</span><span class="ace_punctuation">,</span> <span class="ace_constant ace_numeric">4</span><span class="ace_punctuation">,</span> <span class="ace_constant ace_numeric">5</span><span class="ace_punctuation">,</span> <span class="ace_constant ace_numeric">6</span><span class="ace_paren ace_rparen">]</span></div><div class="ace_line" style="height: 21px; top: 147px;"><span class="ace_identifier">result</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">sum_even_odd</span><span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">list</span><span class="ace_paren ace_rparen">)</span></div><div class="ace_line" style="height: 21px; top: 168px;"><span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">result</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_overwrite-cursors ace_hidden-cursors"><div class="ace_cursor" style="animation-duration: 1000ms; display: block; top: 147px; left: 173px; width: 8px; height: 21px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; bottom: 0px; display: none;"><div class="ace_scrollbar-inner" style="width: 20px; height: 189px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 40.6973px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 948px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></div>
        <div class="boxed" id="editor_footer"> Ln: 8, Col: 23</div>
        </div>
    ...
    <div class="gutter gutter-vertical" style="height: 5px;"></div><div id="d" class="split" style="height: calc(28% - 2.5px);">
        ...
        <div id="terminal">
            <div id="progress-status"><div class="progress" id="progress-bar"><div class="progress-bar progress-bar-success active" role="progressbar"></div></div></div>
            <div class="boxed2" id="output" style="display: block;"><div class="wrapper" id="wrap"><p id="term-output">(12, 9)
</p><p id="term-output">

** Process exited - Return Code: 0 **</p><p id="term-output">
...
__tcfapi("removeEventListener",2,function(success){return null;},tcdata.listenerId);if(!(tcdata.purpose.consents["1"]===true&&_ezAllowed(tcdata,"2")&&_ezAllowed(tcdata,"3")&&_ezAllowed(tcdata,"4"))){if(typeof __ez=="object"&&typeof __ez.bit=="object"&&typeof window["_ezaq"]=="object"&&typeof window["_ezaq"]["page_view_id"]=="string"){__ez.bit.Add(window["_ezaq"]["page_view_id"],[new __ezDotData("non_personalized_ads",true),]);}}}});}else{_setAllEzConsentTrue();window._emitEzConsentEvent();}})(window,document);</script><iframe src="./even ,odd sum_files/aframe.html" width="0" height="0" style="display: none;"></iframe><script src="./even ,odd sum_files/ezjitscroll.js.download" async=""></script><script src="./even ,odd sum_files/ezicsticky.js.download" async=""></script><script src="./even ,odd sum_files/ezjitpos.js.download" async=""></script><div id="uglipop_overlay_wrapper" style="position:absolute;top:0;bottom:0;left:0;right:0;display:none"><div id="uglipop_overlay" style="position: fixed; inset: 0px; opacity: 0.3; width: 100%; height: 100%; background-color: black; display: none;"></div></div><div id="uglipop_content_fixed" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); opacity: 1; z-index: 10000000; display: none;"><div id="uglipop_popbox"></div></div><script src="./even ,odd sum_files/ezadloadhb.js.download" async=""></script><script src="./even ,odd sum_files/ezadloadamzn.js.download" async=""></script><script src="./even ,odd sum_files/dall.js.download"></script><iframe marginwidth="0" marginheight="0" scrolling="no" frameborder="0" id="1f326f0b55a164" width="0" height="0" src="./even ,odd sum_files/saved_resource(3).html" name="__pb_locator__" style="display: none; height: 0px; width: 0px; border: 0px;"></iframe><iframe name="__launchpadLocator" style="display: none;" src="./even ,odd sum_files/saved_resource(4).html"></iframe><iframe src="./even ,odd sum_files/iu3.html" style="display: none;"></iframe><script src="./even ,odd sum_files/ezadfilled.js.download" async=""></script><script src="./even ,odd sum_files/524(1)"></script><img height="1" width="1" src="./even ,odd sum_files/halo_match" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/ip_match" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/ux" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/getuid" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/rtset" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/0" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/cm" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/ebfa23da174faa55634171c5e49d0152.gif" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/ium" alt="" style="display: none;"><img height="1" width="1" src="./even ,odd sum_files/saved_resource" alt="" style="display: none;"><script type="text/javascript" src="./even ,odd sum_files/getpixels" async=""></script><iframe src="./even ,odd sum_files/join-ad-interest-groups.html" allow="join-ad-interest-group; attribution-reporting" sandbox="allow-scripts allow-same-origin" style="display: none;"></iframe><script src="./even ,odd sum_files/ezidentity.js.download" async=""></script><div class=" ace_editor ace_autocomplete ace-tm" style="top: 134.4px; left: 397.452px; height: 172.375px; display: none;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; top: 0px; left: -100px;"></textarea><div class="ace_gutter" aria-hidden="true" style="display: none; left: 0px; width: 42px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: 0px; left: 0px; width: 42px;"><div class="ace_gutter-cell " style="height: 21.5469px; top: 0px;">1<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 21.5469px; top: 21.5469px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 21.5469px; top: 43.0938px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 21.5469px; top: 64.6406px;">4<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 0px; left: 0px; right: 15px; bottom: 0px;"><div class="ace_content" style="cursor: default; top: 0px; left: 0px; width: 283px; height: 215.469px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 4px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 21.5469px; top: 0px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: 0px; left: 0px;"><div class="ace_line ace_selected" style="height: 21.5469px; top: 0px;"><span class="ace_completion-highlight">al</span><span class="ace_">l</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 21.5469px;"><span class="ace_">Ex</span><span class="ace_completion-highlight">a</span><span class="ace_">mp</span><span class="ace_completion-highlight">l</span><span class="ace_">e</span><span class="ace_completion-meta">local</span></div><div class="ace_line" style="height: 21.5469px; top: 43.0938px;"><span class="ace_">c</span><span class="ace_completion-highlight">al</span><span class="ace_">lable</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 64.6406px;"><span class="ace_">F</span><span class="ace_completion-highlight">al</span><span class="ace_">se</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 86.1875px;"><span class="ace_completion-highlight">a</span><span class="ace_">pp</span><span class="ace_completion-highlight">l</span><span class="ace_">y</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 107.734px;"><span class="ace_">ev</span><span class="ace_completion-highlight">al</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 129.281px;"><span class="ace_">fin</span><span class="ace_completion-highlight">al</span><span class="ace_">ly</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 150.828px;"><span class="ace_">loc</span><span class="ace_completion-highlight">al</span><span class="ace_">s</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 21.5469px; top: 172.375px;"><span class="ace_">glob</span><span class="ace_completion-highlight">al</span><span class="ace_completion-meta">keyword</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors" style="opacity: 0;"><div class="ace_cursor" style="display: block; top: 0px; left: 4px; width: 8px; height: 21.5469px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 280.109px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 0px; right: 15px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 283px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></div></body><iframe id="google_esf" name="google_esf" src="./even ,odd sum_files/zrt_lookup_fy2021.html" style="display: none;"></iframe><iframe name="goog_topics_frame" src="./even ,odd sum_files/topics_frame.html" style="display: none;"></iframe><iframe sandbox="allow-scripts allow-same-origin" id="34c4f624c028f16" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/checksync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="35d862356ee5db9" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/syncframe.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="3646a838b4784ec" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/user_sync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="37d651e491374c7" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/pd.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="38c10a32a3e74d9" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/sync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="397d3b30d4c1daf" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/usync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="404bf7edef8d633" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./even ,odd sum_files/saved_resource(5).html">
    </iframe></html>